    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-xl shadow-lg bg-gray-200 flex flex-col items-center justify-center p-4 border border-gray-700"
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-xs font-bold tracking-[0.2em] text-gray-200"
                    >
                        SCROLL TO EXPLORE
                    </motion.p>
                </div>
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-semibold text-gray-300 tracking-tight mb-4">
                        Explore Our Vision
                    </h2>
