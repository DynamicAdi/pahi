...
export default function Home() {
  return (
    <>
      {/* Overlay animations */}
      <div className="absolute opacity-0 bg-black! dark:bg-white! z-40! inset-0 transition-all animate-click-picture h-full w-full" />
      <div className="absolute inset-0 h-full w-full z-9999 animate-load-in transition-all" />
